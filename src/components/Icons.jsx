...
export function IconAccount({ size = 24 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconHeart({ size = 24, filled = false }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconDelivery({ size = 28 }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <line x1="11" y1="16" x2="11" y2="3" />
    </svg>
  );
}

export function IconFresh({ size = 28 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCheckAll({ size = 22 }) {
  return (
    <svg
      width={size}
      height={size}
