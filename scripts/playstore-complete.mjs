...
// Screens that show content WITHOUT login
const SCREENS = [
  {
    id: 1, path: '/', name: 'home',
  ...
  },
  {
    ...
    bannerTitle: 'Easy Login',
    bannerSubtitle: 'Sign In to Your Account',
    promoText: 'Quick login with email — create account in seconds'
  },
  {
    id: 4, path: '/signup', name: 'signup',
    bannerTitle: 'Create Account',
    bannerSubtitle: 'Join Hashmi Mart Today',
    promoText: 'Sign up free and start ordering fresh groceries'
  },
  {
  ...
  {
    id: 6, path: '/products', name: 'categories',
    bannerTitle: 'Wholesale Deals',
    bannerSubtitle: 'Best Prices for Bulk Orders',
    promoText: 'Save more when you buy wholesale — perfect for families and businesses'
  }
];
...
async function run() {
  console.log('🏪 Hashmi Mart — Play Store Screenshots (Complete)\n');
  ...
  console.log('\n🎨 Creating mockups with banner + promo...\n');
...
<html><head><style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body { width: 1024px; height: 1024px; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #f0fdfa, #fff); }
  img { width: 600px; height: 600px; object-fit: contain; }
</style></head><body><img src="${logoBase64}" alt="Hashmi Mart"></body></html>`, { waitUntil: 'load' });
  ...
  // ─── Splash Screen ─────────────────────────────────────────────────
  console.log('\n🚀 Creating Splash Screen (1000×1500)...');
...
<html><head><style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body { width: 1000px; height: 1500px; display: flex; align-items: center; justify-content: center; background: linear-gradient(180deg, #06b6d4, #0891b2 50%, #0e7490); font-family: -apple-system, sans-serif; overflow: hidden; position: relative; }
  ...
  .content { display: flex; flex-direction: column; align-items: center; text-align: center; padding: 100px; position: relative; z-index: 1; }
  ...
  <div class="content"><img src="${logoBase64}" class="logo" alt="Logo"><div class="name">Hashmi Mart</div><div class="tagline">Premium Fresh Groceries<br>Delivered Fast in Lahore</div></div>
...
<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs><linearGradient id="g" x1="0" y1="0" x2="192" y2="192" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#06b6d4"/><stop offset="100%" stop-color="#0891b2"/></linearGradient></defs>
  <rect width="192" height="192" rx="42" fill="url(#g)"/>
  <text x="96" y="128" font-family="Arial" font-size="96" font-weight="bold" fill="white" text-anchor="middle">H</text>
</svg>`);
  ...
  console.log('  📸  02-products.png');
  console.log('  📸  03-login.png');
  console.log('  📸  04-signup.png');
  console.log('  📸  05-cart.png');
  console.log('  📸  06-categories.png');
  console.log('\n' + '═'.repeat(55));
}
